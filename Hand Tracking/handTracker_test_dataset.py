...
class HandTracker:
    ...
    def createDataset(window_name, letter, count, list_of_coords):
        ...
        # Get picture count
        excel_file = r"Training NN\Datasets\Test Data\test_dataset.xlsx"
        ...
        ss.save(r"C:\Users\liamo\Documents\FYP\Training NN\Datasets\Test Data\\" + letter + "\\" + letter + row_count + ".png")
    ...
    def addToExcel(letter, row_count, list_of_coords, excel_file_path):
        ...
        dataset_path = r"Training NN\Datasets\Test Data"
